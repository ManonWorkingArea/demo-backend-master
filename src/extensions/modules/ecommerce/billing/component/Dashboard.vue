...
<main class="flex-1 pb-8">
    ...
    <div class="mt-8">
        ...
        <h2 class="mx-auto mt-8 max-w-7xl px-4 text-lg font-medium leading-6 text-gray-900 sm:px-6 lg:px-4">Billing Dashboard</h2>
                    ...
                    <a href="#" class="block bg-white px-4 py-4 hover:bg-gray-50">
                        <span class="flex items-center space-x-4">
                            <span class="flex flex-1 space-x-2 truncate">
                                <svg class="h-5 w-5 flex-shrink-0 text-gray-400" x-description="Heroicon name: mini/banknotes" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        ...
                        <span class="flex items-center space-x-4">
                            <span class="flex flex-1 space-x-2 truncate">
                                ...
                                <span class="flex flex-col truncate text-sm text-gray-500">
                                    ...
                                    <span><span class="font-medium text-gray-900">$19,500</span> USD</span>
                        ...
                        <span class="flex items-center space-x-4">
                            <span class="flex flex-1 space-x-2 truncate">
                                ...
                                <span class="flex flex-col truncate text-sm text-gray-500">
                                    ...
                                    <span><span class="font-medium text-gray-900">$8,750</span> USD</span>
                        ...
                        <span class="flex items-center space-x-4">
                            <span class="flex flex-1 space-x-2 truncate">
                                ...
                                <span class="flex flex-col truncate text-sm text-gray-500">
                                    ...
                                    <span><span class="font-medium text-gray-900">$300</span> USD</span>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                    ...
                                    <td class="w-full max-w-0 whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                                        <div class="flex">
                                            <a href="#" class="group inline-flex space-x-2 truncate text-sm">
                                                <svg class="h-5 w-5 flex-shrink-0 text-gray-400 group-hover:text-gray-500" x-description="Heroicon name: mini/banknotes" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                    <path fill-rule="evenodd" d="M1 4a1 1 0 011-1h16a1 1 0 011 1v8a1 1 0 01-1 1H2a1 1 0 01-1-1V4zm12 4a3 3 0 11-6 0 3 3 0 016 0zM4 9a1 1 0 100-2 1 1 0 000 2zm13-1a1 1 0 11-2 0 1 1 0 012 0zM1.75 14.5a.75.75 0 000 1.5c4.417 0 8.693.603 12.749 1.73 1.111.309 2.251-.512 2.251-1.696v-.784a.75.75 0 00-1.5 0v.784a.272.272 0 01-.35.25A49.043 49.043 0 001.75 14.5z" clip-rule="evenodd"></path>
                                                </svg>
                                ...
                                <tr class="bg-white">
                                    <td class="w-full max-w-0 whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                                        <div class="flex">
                                            <a href="#" class="group inline-flex space-x-2 truncate text-sm">
                                                ...
                                                <p class="truncate text-gray-500 group-hover:text-gray-900">Payment to Doug Mann</p>
                                            </a>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                                    ...
                                    <td class="hidden whitespace-nowrap px-6 py-4 text-sm text-gray-500 md:block">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 capitalize">processing</span>
                                    </td>
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                                        <time datetime="2020-07-05">July 5, 2020</time>
                                    </td>
                                    ...
                                    <td class="w-full max-w-0 whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                                        <div class="flex">
                                            <a href="#" class="group inline-flex space-x-2 truncate text-sm">
                                                ...
                                                <p class="truncate text-gray-500 group-hover:text-gray-900">Payment to Erica Frost</p>
                                            </a>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                                    ...
                                    <td class="w-full max-w-0 whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                                        <div class="flex">
                                            <a href="#" class="group inline-flex space-x-2 truncate text-sm">
                                                ...
                                                <p class="truncate text-gray-500 group-hover:text-gray-900">Payment to Miley Davis</p>
                                            </a>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                                ...
                                <tr class="bg-white">
                                    ...
                                    <td class="hidden whitespace-nowrap px-6 py-4 text-sm text-gray-500 md:block">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 capitalize">failed</span>
                                    </td>
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                                        <time datetime="2020-06-17">June 17, 2020</time>
                                    </td>
