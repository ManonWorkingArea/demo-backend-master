                        ...
                        <div class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
                            ...
                            <div class="mt-4">
                                <h3 class="text-lg font-medium">
                                    <router-link to="/shop/products" class="focus:outline-none">
                                        <span class="absolute inset-0" aria-hidden="true"></span>
                                        <font-awesome-icon :icon="['fas','folder']" class="text-yellow-500"/> สินค้า
                                    </router-link>
                                </h3>
                            ...
                            <div class="mt-4">
                                <h3 class="text-lg font-medium">
                                <router-link to="/shop/config" class="focus:outline-none">
                                    <span class="absolute inset-0" aria-hidden="true"></span>
