...
export default {
    ...
    async getData() {
        try {
          ...
          const enrollAPI = await fetch("https://gateway.cloudrestfulapi.com/api/property/query", {
              method: 'POST',
        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div class="mx-auto grid max-w-2xl grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            ...
            <div class="-mx-4 px-4 py-4 shadow-sm ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-4 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-8 xl:pb-10 xl:pt-8">
              ...
              <h2 class="text-base font-semibold leading-6 text-gray-900 ">ประกาศของคุณ</h2>
              ...
              <table class="mt-2 w-full whitespace-nowrap text-left text-sm leading-6">
                ...
                <thead class="border-b border-gray-200 text-gray-900">
                  <tr>
                    <th scope="col" class="px-0 py-3 font-semibold">ชื่อประกาศ</th>
