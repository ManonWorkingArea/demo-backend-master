...
<template>
    ...
    <div v-if="loading_sources">
            ...
            <div class="w-full px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                ...
                <div class="mt-5 flex xl:mt-0 xl:ml-4">
                    <span class="hidden sm:block">        
                        <button @click="$router.push('/lesson/home')" type="button" class="ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-50">
        ...
        <div class="flex-1 bg-gray-100 pb-5 border-t">
            <div class="">
                <div class="w-full">
                    <div class=" sm:px-6 lg:col-span-9 lg:px-0">
                        ...
                        <Editor ref="editorComponent" :mode="'add'" :master="this.master" />
