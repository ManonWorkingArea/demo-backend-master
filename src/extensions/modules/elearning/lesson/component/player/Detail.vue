...
export default {
    ...
    methods: {
      reloadComponent() {
        this.refreshKey += 1; // Increment key value to trigger re-render
        this.getData();
      },
            ...
            <div class="divide-y divide-gray-200">
              ...
              <div class="px-4 py-6 sm:px-6">
                <figure v-if="(playerData.video!=undefined)">
                  ...
                  <vue-plyr class="relative" v-if="this.type=='streaming' || this.type=='demand'">
                  ...
                  <vue-plyr class="w-full" v-if="this.type=='youtube'" v-html="this.videoContent">
                  </vue-plyr>
