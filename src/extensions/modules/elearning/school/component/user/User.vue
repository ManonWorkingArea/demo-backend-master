                ...
                <table class="min-w-full divide-y divide-gray-300">
                  <thead class="bg-gray-50">
                    <tr>
                      ...
                      <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Assignment</th>
                  ...
                  <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr v-for="(admin, index) in listItems" :key="admin._id">
                      ...
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <a :href="'/school/user/detail/'+admin._id" class="text-gray-500 hover:text-indigo-900">
                      ...
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ admin.unit ? (admin.unit.length > 0 ? admin.unit.length : '0') : '0' }} Units</td>
                      <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-md font-medium sm:pr-6">
                        <button @click="assignAdmin(admin._id)" type="button" class="mr-2 inline-flex justify-center rounded-md border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2">
                          ...
                          <button @click="deleteData(admin._id)" type="button" class="inline-flex justify-center rounded-md border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2">
