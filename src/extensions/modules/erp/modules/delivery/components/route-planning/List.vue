      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="mt-2 text-gray-600">วางแผนเส้นทางการจัดส่ง</p>
          </div>
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium text-gray-500">Route Planning</span>
              </div>
            </li>
          </ol>
        </nav>
...
<script>
/**
 * ✅ CORE COMPLIANT - Route Planning List
...
export default {
  ...
  setup() {
    ...
    return {
      ROUTE_STATES: delivery.ROUTE_STATES || {},
      OPTIMIZATION_TYPES: delivery.OPTIMIZATION_TYPES || {}
    }
  }
}
</script>