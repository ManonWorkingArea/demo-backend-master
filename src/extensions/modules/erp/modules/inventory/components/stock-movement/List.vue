          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium text-gray-500">Stock Movement / Transfer</span>
              </div>
            </li>
          </ol>
        </nav>
...
<script>
/**
 * ✅ CORE COMPLIANT - Stock Movement List
...
export default {
  ...
  setup() {
    ...
    return {
      INVENTORY_MOVEMENT_TYPES: inventory.INVENTORY_MOVEMENT_TYPES || {}
    }
  }
}
</script>