          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium text-gray-500">Production Progress</span>
              </div>
            </li>
          </ol>
        </nav>
...
<script>
/**
 * ✅ CORE COMPLIANT - Production Progress List
 * ใช้ Dynamic Module Loading
 */
export default {
  name: 'ProductionProgressList',
  setup() {
    ...
    return {
      ...
      PROGRESS_STATES: production.PROGRESS_STATES || {},
      PRODUCTION_STEPS: production.PRODUCTION_STEPS || {}
    }
  }
}
</script>