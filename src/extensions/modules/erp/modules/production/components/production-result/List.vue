<template>
  <div class="min-h-screen bg-gray-50">
    <div class="production-result-list">
      <h2>Production Result / FG Output</h2>
      <!-- Production result dashboard -->
    </div>
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium text-gray-500">Production Result</span>
              </div>
            </li>
          </ol>
        </nav>
...
<script>
/**
 * ✅ CORE COMPLIANT - Production Result List
...
export default {
  ...
  setup() {
    ...
    return {
      PRODUCTION_RESULT_STATES: production.PRODUCTION_RESULT_STATES || {},
      FG_LOT_STATES: production.FG_LOT_STATES || {},
