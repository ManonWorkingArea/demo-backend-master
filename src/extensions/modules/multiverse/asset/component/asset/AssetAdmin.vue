...
<template>
  ...
  [
    {
      name: 'ย้อนกลับ',
      link: '/asset/asset/' + this.dataItem,
      style: 'chevron-left'
    },
    {
      name: 'เพิ่มผู้ดูแลระบบ',
      link: '/asset/user/add/' + this.dataItem,
      style: 'plus'
    }
  ]"
  /> 
                ...
                <table class="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr v-for="(admin, index) in listItems" :key="admin._id">
                      ...
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ admin.asset ? (admin.asset.length > 0 ? admin.asset.length : '0') : '0' }} Assets</td>
                      <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-md font-medium sm:pr-6">
                        ...
                        <template v-if="!admin.asset || admin.asset.length === 0">
