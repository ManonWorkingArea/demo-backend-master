                  ...
                  <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr v-for="(admin, index) in listItems" :key="admin._id">
                      ...
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <a :href="'/asset/user/detail/'+admin._id" class="text-gray-500 hover:text-indigo-900">
                      ...
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ admin.asset ? (admin.asset.length > 0 ? admin.asset.length : '0') : '0' }} asset</td>
