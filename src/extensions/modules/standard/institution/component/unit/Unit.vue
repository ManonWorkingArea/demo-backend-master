...
<template>
  ...
  [
    {
      name: 'เพิ่ม Institution',
      link: '/institution/add',
      style: 'plus'
    }
  ]"
  /> 
            ...
            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div v-for="(asset) in listItems" :key="asset._id" class="bg-white rounded-lg shadow-md overflow-hidden">
                  ...
                  <div class="p-4">
                    <a :href="'/institution/detail/'+asset._id" class="font-bold text-gray-600 hover:underline">{{ asset.siteName }}</a>
                  ...
                  <div class="bg-gray-100 border-t-2 border-gray-200 py-2 px-4 flex justify-between items-center">
                    <a href="javascript:void(0);" @click="$router.push('/institution/edit/'+ asset._id)" class="text-gray-900 hover:text-gray-500 text-md font-medium">
                      <font-awesome-icon :icon="['fas','square-pen']" class="text-black mt-[3px] mr-2 text-md"/>
                      <span>แก้ไข</span>
                    </a>

                    <a href="javascript:void(0);" @click="$router.push('/institution/admin/'+ asset._id)" class="text-gray-900 hover:text-gray-500 text-md font-medium">
                ...
                <a :href="'/institution/add'" class="bg-white p-10 rounded-lg shadow-md overflow-hidden flex flex-col items-center justify-center cursor-pointer p-10">
                  ...
                  <p class="text-gray-500 mt-2 text-center">Add Institution</p>
                </a>
