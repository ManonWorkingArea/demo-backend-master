    ...
    <header class="py-2 bg-white border-l border-r border-b border-1 border-gray-200">
      <div class="mx-auto  px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
        <div class="min-w-0 flex-1">
            <h1 class="mt-1 text-[18px] font-semibold leading-8 text-gray-700"><font-awesome-icon :icon="['fas',this.PageIcon]" class="text-gray-500 text-[18px]"/> {{ title ? title : this.PageName }}</h1>
        </div>
